...
// enum state stateChange(enum char_type c, enum state st)
// {
//     switch (st)
//     {
//     case S_WAIT:
...
// void clearArgv(char *x_argv[], int arg_beg)
// {
//     for (int i = arg_beg; i < MAXARG; i++)
//     {
//         x_argv[i] = 0;
//     }
// }
...
//         st = stateChange(st, getChar(*p));

//         if (++arg_end >= MAXSZ)
//         {
//             fprintf(2, "xarg: args too long\n");
//             exit(1);
//         }
